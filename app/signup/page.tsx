    ...
    <div className="min-h-screen flex bg-slate-50">
        ...
        <div className="w-full max-w-md mt-12 lg:mt-0">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-slate-50 text-slate-500">Or sign up with email</span>
            </div>
          </div>
      ...
      <div className="hidden lg:flex w-1/2 bg-slate-900 relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center max-w-lg mx-auto">
          <h2 className="text-3xl font-bold text-white mb-8">Join thousands of students building their careers</h2>
